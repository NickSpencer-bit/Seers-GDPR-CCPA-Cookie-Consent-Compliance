...
Seers CMP (Cookie Consent Management Platform) enables you to implement Cookie Banner/ Cookie Notice on your website. 
Seers helps make websites compliant with GDPR (DSGVO), PECR and ePrivacy Directives.
Cookie Consent Plugin is intended to supplement individuals’ privacy rights and protections provided under all the privacy regulations in the European Union's GDPR, California's CCPA, Singapore's PDPA, South Africa's POPIA, UK's GDPR, Brazil’s LGPD, Canadian PIPEDA, Australia’s OAIC, China PIPL and more.
Obtain GDPR and ePrivacy Directive compliant consents, as well as services and cookies, and fill all your cookie banners with legal information.
The Seers Plugin is one of the best for WordPress GDPR Compliance which has features stated below:

https://www.youtube.com/watch?v=khUK9dZJ2dI

== KEY FEATURES ==

• Configure a Cookie Notice for specific regions like the EU, the UK, the USA, Australia, South Africa, Brazil, China or Canada. 
• Also, configure specific cookie consent for sub-regions such as the EU + GDPR/DSGVO/CNIL or the United States + CCPA. 
• Scan your Website Cookies so you can quickly enlist the cookies your website is using in the cookie and privacy policy.
• Get Cookie Consent and Conditional Cookie Notice with Customisable Templates and Custom CSS.  
• This cookie consent plugin adds a GDPR compliant cookie banner to your website at any position (header, footer, right, left, etc.) you would like. 
• Banner templates for UK/US/CA/AU with accept, reject and customisation buttons are included. 
• Automatically detects the requirement for a Cookie Banner or Cookie Notice and scans for updates in Plugins, Cookies, and third-party services regularly.  
• With the support of this WordPress GDPR plugin, you can fully customise the cookie notice style so that it blends in with your existing website’s theme. 
• It can modify the colors, fonts, styles, the location on the page, and even how it behaves when you click "Accept" or "Allow".
• Integrates with google consent mode and Interactive Advertising Bureau (IAB). 
• Implementation of Google Analytics, Google Tag Manager, Clicky, Matomo, etc. Use Tag Manager and automatically anonymises IP addresses for Google Analytics if needed. 
• Blocks third-party cookies (Google Maps, AdSense, Recaptcha, ActiveCampaign, HubSpot, Twitter, Facebook, Instagram, etc. ), iFrames ( YouTube, Dailymotion, Vimeo, etc. ) and social iFrames ( Facebook, Instagram, etc. ).
• Cookie Audit report to prove compliance and showcase what cookie your website uses. 
• Explicit Consent. Accept, Reject & Setting. GDPR Article 7
• Comes with the Admin Panel to control all the settings related to displayed cookies and their description. Cookie Banner settings, sizes, wordings, etc. 
...
• Seamlessly integrates with local or other popular plugins, for example, Gutenberg Google Analytics, Google Maps Widgets, WP Forms, WP Google Maps, Easy Digital Downloads, Contact Form 7, WPBakery, Woocommerce, Gravity Forms, Divi, Elementor, Foeminator, Beehive, GADWP, and many more.   
...
1. EU GDPR (DSGVO): The General Data Protection Regulation 
1. PECR: The Privacy and Electronic Communications Regulations
1. ePrivacy directive
1. France's CNIL: Commission Nationale Informatique & Libertiés
1. Canadian PIPEDA: The Personal Information Protection and Electronic Documents Act 
1. California CCPA, USA: The California Consumer Privacy Act 
1. Brazilian LGPD: The Brazilian General Data Protection Law 
1. Australian OAIC: Australia’s Privacy Principles
1. Chinese PIPL: Personal Information Protection Law 
1. Indian PDPB: Personal Data Protection Bill 
...
• Manages Cookie Categories and list of cookies such as CookieID, Name, Description, Type, Category, Duration, Header & Footer Script. 
• Full customisation of buttons, styles, colors, and fonts resembling your own website's theme and style. 
• Displays the cookie banner in the header, footer, as a pop-up, or as a widget. 
• Enables to display cookie notice settings popup where site visitors can give consent to cookie categories. 
• Automatically scans and blocks scripts such as Google Analytics, Google Tag Manager, Pixel, Instagram, Facebook, etc. 
• The consent analytics dashboard allows you to track how visitors' consents and make adjustments accordingly. 
• Improve your cookie banner acceptance rate by monitoring progress via a consent activity graph.
• Enables users to have granular control over the cookies and scripts for websites. 
...
• Change the title of the menue item.
